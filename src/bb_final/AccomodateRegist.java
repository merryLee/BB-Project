...
public class AccomodateRegist extends JPanel {
	...
	public AccomodateRegist() {
		...
		textField.setBounds(142, 112, 226, 21);
		add(textField);
		...
		textField_1.setBounds(402, 112, 216, 21);
		add(textField_1);
		...
		textField_2.setBounds(142, 168, 226, 21);
		add(textField_2);
		...
		textField_3.setBounds(402, 168, 216, 21);
		add(textField_3);
		...
		textField_4.setBounds(142, 224, 226, 21);
		add(textField_4);
		...
		comboBox.setBounds(402, 224, 216, 21);
		add(comboBox);
		...
		label_6.setBackground(new Color(102, 205, 170));
		label_6.setBounds(142, 403, 99, 80);
		add(label_6);
		
		JButton regi_file_btn1 = new JButton("\uD30C\uC77C\uC120\uD0DD");
		...
		JButton regi_file_btn2 = new JButton("\uD30C\uC77C\uC120\uD0DD");
		...
		JButton regi_file_btn3 = new JButton("\uD30C\uC77C\uC120\uD0DD");
		...
		textArea.setBounds(142, 524, 474, 128);
		add(textArea);
		...
		lblNewLabel.setBounds(253, 404, 267, 22);
		add(lblNewLabel);
		...
		label_11.setBounds(253, 432, 267, 22);
		add(label_11);
		...
		label_12.setBounds(253, 461, 267, 22);
		add(label_12);
